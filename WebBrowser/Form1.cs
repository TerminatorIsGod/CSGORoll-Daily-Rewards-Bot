...
namespace WebBrowser
{
    public partial class Form1 : Form
    {
        ...
        private void messagedReceived(object sender, CoreWebView2WebMessageReceivedEventArgs args)
        {
            ...
            string timeStr = args.TryGetWebMessageAsString();
            if(timeStr.Contains("TimeMessage: "))
            {
                timeLeftStr = timeStr.Replace("TimeMessage: ", "");
